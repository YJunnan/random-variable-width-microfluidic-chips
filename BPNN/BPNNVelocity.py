...
trainingSet = pd.read_csv('BPNN-RVW.csv', header=None)
testSet = pd.read_csv('BPNN-RVW.csv', header=None)

# 导入数据
X = trainingSet.iloc[0:8000, 0:40]
y = trainingSet.iloc[0:8000, 43:46]  # concentration
test_X = testSet.iloc[8000:10232, 0:40]
test_y = testSet.iloc[8000:10232, 43:46]
...
net = Net(n_feature=40, n_hidden=25, n_output=3)
net.cuda()
print(net)
...
plt.savefig('./results/velocity/velocity_net_train_loss.png')
np.save('./results/velocity/velocity_train_loss_his.npy', loss_his)
...
plt.savefig('./results/velocity/velocity_net_test_loss.png')
np.save('./results/velocity/velocity_test_loss_his.npy', test_loss_his)
...
plt.ylabel('Accuracy')
plt.ylim(0,1)
plt.savefig('./results/velocity/velocity_net_test_accuracy.png')

np.save('./results/velocity/velocity_test_accuracy.npy', accuracy_his)
...
plt.ylabel('Accuracy')
plt.ylim(0,1)
plt.savefig('./results/velocity/velocity_net_train_accuracy.png')
np.save('./results/velocity/velocity_train_accuracy.npy', train_accuracy_his)
torch.save(net, ('./results/velocity/velocity_net.pkl'))
