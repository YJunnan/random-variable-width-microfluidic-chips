...
Y = data.iloc[:, 81:83].to_numpy()  # concentration
...
#np.savetxt('test_yC.csv', test_y.reshape(2558,2), delimiter = ',')
#np.savetxt('train_Xc.csv', train_X.reshape(7674,81), delimiter = ',')
#np.savetxt('train_yc.csv', train_y.reshape(7674,2), delimiter = ',')
test_X = (test_X).cuda()
test_y = (test_y).cuda()
